# Middle Tennessee Operations: bounded first pass
...
The follow-up reuses two already pinned OCRs through new selections; their metadata
and OCR are unchanged:

- **Cist**, *The Army of the Cumberland* (1882), Chapter IX: Dover, Thompson's
  Station and Vaught's Hill (OCR pp.140–144). Cist is an interested Union staff history.
- **Jordan and Pryor**, *Campaigns of Lieut.-Gen. N. B. Forrest* (1868), Chapter VIII:
  Dover, Thompson's Station, Brentwood and the Franklin reconnaissance (pp.224–248).
  Forrest's prefatory note accepts responsibility for most of the book, so it is not
  independent of him.

Dover and Thompson's Station therefore use three families; Vaught's Hill uses NPS and
Cist, and Brentwood and Franklin NPS and Jordan and Pryor. The Jordan scan crops some
line starts; quotes avoid cropped fragments, and page locators use an explicit marker
map because several running heads are misread (p.228 prints "128", p.229 "22^", p.247
"347"). No maps, rosters or print pages were inspected.

Twelve new source records bring the registry to **361 entries / 358 raw paths**,
preserving the earlier **349/346**: five NPS HTML/text pairs and two selections.
...
- **Casualties differ** (frozen/live): Dover **796 / 965**, Thompson's Station
  **2,206 / 1,957**, Vaught's Hill **435 / 188**, Brentwood **311 / 532**; Franklin
  agrees at 237. Book figures differ again and are not adopted.
- **Information and command**: Gilbert ordered Coburn forward despite his warning
  (Cist); Granger acted on a false report and Stanley attacked without orders (NPS);
  Forrest's objection to the Dover expedition passed without heed (Jordan and Pryor).
  No listed commander receives automatic sole credit. Dover's works and Brentwood's
  site are tagged `inherited`.

The seven null unknowns are five opening strengths and logistics at Vaught's Hill and
Franklin. No morale/readiness score, probability, causal effect or new commander ranking
