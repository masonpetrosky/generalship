# Mine Run Campaign: bounded first pass
...
Read the frozen battle, force and commander rows and the retained live NPS summary in
full. NPS/CWSAC and the Arnold tables are one family. Two further families each get a new
selection from already pinned OCR:
...
- **Humphreys**, *Gettysburg to the Rapidan* (1883), Chapter III, reusing
  ...
  list.
- **Lee's** reports (No. 100) from *Official Records* Series I, Volume XXIX, Part 1
  (`or29-1-illinois-ocr-v1`), pp.823–830: eight telegrams dated November 26 to December
  2, the December 2 and December 3 letters and the April 27, 1864 report.

Several Humphreys running heads are misread. The heads for pp.50, 51, 56, 61, 67 and 70
read "SO", "5 1", "$6", "6l", "6?" and "JO", and no p.60 head appears. Citations on those
pages carry inferred locators; text between the p.59 and p.61 heads is located as
"p.59 or p.60".

The abstract of the Confederate November 20 field return (No. 99), which precedes Lee's
reports, was seen but not selected: its columns are garbled. No Union reports, other
Confederate reports, maps or print pages were inspected. Stop after this batch.

Four new source records bring the registry to **568 entries / 548 raw paths**,
preserving the earlier **564/544**: one NPS HTML/text pair and two selections.

## Decisions and limits

- **Scope.** The record covers Payne's Farm, New Hope Church and the Mine Run lines, as
  the frozen other names and description indicate. The November 26 crossing and the
  December 2 pursuit are context at the interval edges.
- **Opening strength remains unknown.** The frozen bounds (US 69,643; CS 44,426) are
  imported army figures and remain unchanged. None of these figures is adopted:
  - Humphreys's infantry figures: Ewell 15,650 and Hill 17,500 enlisted men;
...
- **Disputes preserved.**
  - Payne's Farm: Lee says Johnson drove the enemy back; Humphreys says the Third Corps
    ...
    was scattered.
  - Rosser's raid:
    - Lee's December 2 letter: 18 wagons, 280 mules and 150 prisoners;
    - Humphreys, citing Rosser: eight wagons, seven ambulances, 280 mules and ninety-five
      prisoners.
  - Johnson's loss: 498 in Humphreys, 545 in Lee.
