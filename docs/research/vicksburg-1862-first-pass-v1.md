...
unknowns and 62 citation occurrences**. All seven dimensions are represented in each
record. Separate review is pending. All dossiers remain drafts; no features are admitted.

| Record | Dates (frozen) | Claims | Unknowns | Citations | Families |
| --- | --- | ---: | ---: | ---: | ---: |
| MS003 — Chickasaw Bayou | 1862-12-26 to 12-29 | 9 | 1 | 30 | 2 |
| AR006 — Arkansas Post | 1863-01-09 to 01-11 | 10 | 1 | 32 | 2 |
...
- **Opening strengths remain unknown.** Greene gives Sherman's expedition about 32,000
  ...
  and not more than 6,000 in the assaulting brigades. At Arkansas Post he gives the
...
- **Casualties differ** (frozen/live): Chickasaw Bayou **1,983 (US 1,776; CS 207) /
  1,963 (US 1,776; CS 187)**, with Greene's Union 1,929 and Confederate 187 (matching
  the live figure). Arkansas Post **6,547 / 6,096**, with Greene's Union 977 plus 31 on
...
- **Command roles**: Sherman's assault was carried by two brigades and one regiment,
  ...
  Porter. Live headings rank Sherman "General" and Porter "Rear Admiral" against the
