...
unknowns and 141 citation occurrences**. All seven dimensions are represented in each
...
| TN028 — Dandridge | 1864-01-17 | 9 | 1 | 41 | 3 |
| TN029 — Fair Garden | 1864-01-27 | 9 | 1 | 47 | 3 |
...
- **Longstreet's** January 19 report with Lawton's indorsement (pp.93–94) and his January 29
...
- **Opening strengths remain unknown.**
  - Mossy Creek: the frozen Confederate bound of 2,000 is imported and the Union bound is
    blank. The frozen force text attributes to Sturgis a brigade of infantry and about
    2,000 men. The inspected Sturgis passages instead give about 6,000 cavalry and, in a
...
- **Disputes preserved.**
  ...
  - Mossy Creek losses:
    ...
    - the frozen US 151 against live CS 0.
  - Dandridge losses: Longstreet's own-loss estimate of at most 150 is not the frozen
    Union 150. Sturgis's 83 is for the cavalry over two days.
  ...
  - Dandridge's pursuit: NPS names cannons, ammunition and shoes; the inspected Longstreet
    passages name shoes and clothing.
- **Command roles and ranks.**
  ...
  - Parke, not a listed commander, ordered the Dandridge withdrawal.
