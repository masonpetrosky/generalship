# Operations Against the Defenses of Charleston, 1863: bounded first pass
...
Read all six frozen battle, force and commander row sets and the six retained NPS pages in
full. NPS/CWSAC and the Arnold tables are one family.

**Charleston Harbor I (SC004)** uses the two opposing commanders' reports:

- **Du Pont's** April 8 first report and April 16 detailed report from newly pinned *Official
  Records of the Navies* Series I, Volume 14 (1902 imprint; Trent University copy;
  `orn14-trent-ocr-v1`), pp.3–8.
- **Beauregard's** May 19 and October 15, 1863 reports (No. 1, pp.240–245) from *Official
  Records* Series I, Volume XIV (registered with Charleston 1862). The May 19 report transmits
  Ripley's and the engineers' reports (not inspected) and quotes Union statements; its inclosed
  firing table, signed by Jordan and copied from Union journals, was read but not selected.
  Beauregard's group is `beauregard-drewrys-bluff-report`, reused from the main registry.

Read but not selected: the Keokuk and Nahant casualty lists and the order of battle printed with
Du Pont's reports. Samuel Jones's chapter IX was located by contents only.

**SC005–SC009** use two further families:

- **Gillmore's** report dated Hilton Head, February 28, 1864 (No. 2) from newly pinned *Official
  Records* Series I, Volume XXVIII, Part 1 (1890 imprint; `or28-1-illinois-ocr-v1`), read in
  full (pp.3–40). Selected paragraphs 20–46 (plan and forces, pp.5–8), 48–73 (the July 10
  descent, the July 11 assault and Terry's demonstration, pp.8–13), 74–92 (the July 18
  assault, pp.13–16), 93–97 (change of plan, pp.16–17), 128–134 (first bombardment of Sumter,
  pp.20–23), 138–149 (capture of Wagner and the September 8 boat attack, pp.24–28) and 152–154
  (second bombardment, p.30). The report reprints his July 12, August 10 and August 16 letters to
  Halleck and several orders; all sections are mapped to the report's date. His group is
  `gillmore-petersburg-june-9-report`, reused from the main registry, and he is the same author
  family as the Fort Pulaski selection.
- **Samuel Jones, *The Siege of Charleston*** (1911): chapter X from the description of
  Charleston and Morris Island through the July 11 assault (OCR pp.198–221); chapter XI on the
  July 16 attack (pp.224–228) and the July 18 assault (pp.228–246); chapter XII on the first
  bombardment of Sumter (pp.247–261); chapter XIII on the siege and evacuation of Wagner
  (pp.262–277); chapter XIV on the September 8 boat attack, the naval council and the second
  bombardment (pp.278–295). Jones quotes Gillmore's, Seymour's, Strong's, Ripley's,
  Taliaferro's, Keitt's and Dahlgren's words and is not independent of the Official Records
  families.

Read but not selected: Gillmore's introduction, paragraphs 98–127 on the parallels and the Marsh
Battery, his observations (150–151, 155–178) and congratulatory orders. Beauregard's general
report (No. 4), the Morris Island, Grimball's Landing and Fort Sumter subordinate reports, the
returns, and Dahlgren's and Stephens's naval reports were not inspected. No targeted follow-up
was used. Stop after this batch.

## New source records

This campaign adds **20 records**: six NPS HTML/text pairs; the Volume XXVIII Part 1 and Navies
volume 14 catalog metadata and full OCR; and the Du Pont, Beauregard, Gillmore and Jones
Charleston 1863 selections.

## Decisions and limits

- **Scope.**
  - SC004: Hunter's troops, embarked but not landed, are context.
  - SC005 joins the successful July 10 landing and the repulsed July 11 assault; Terry's James
    Island demonstration and Higginson's Edisto raid are context.
  - SC007's frozen interval runs from the July 18 assault through the siege to the evacuation of
    Wagner on the night of September 6–7. SC008 (the bombardments of Sumter, August 17 to
    December 31) and SC009 (the Moultrie engagement and the September 8 boat attack) are separate
    records; siege-wide losses are not added to any one of them.
- **Opening strengths remain unknown.** Frozen bounds: SC006 US 3,800 and CS 3,000; SC007 US
  5,000 and CS 1,800; SC009 US 413; the others are blank. The live pages repeat these (SC009's
  CS is 0). No inspected passage states their basis, except that Gillmore's "about 3,800" for
...
- **Disputes preserved.**
  ...
  - SC005 surprise: Gillmore's secret batteries against Beauregard's statement, quoted by Jones,
    ...
    and 92 wounded on the 10th, 8 officers and 322 men on the 11th and 436 for both, and Jones's Confederate 294 on the 10th and 12 in the assault.
  - SC006: which side was larger (Gillmore against Jones); the demonstration's effect on Morris
    Island's garrison; result (both sides claim their object); frozen US unknown against live
    US 46 and Jones's about fifty.
  - SC007: the bomb-proof's capacity (1,500 to 1,600, Gillmore; 800 to 1,000, Jones); the
  ...
  - SC009: the storming party's size; the live commander (Rear Admiral S. Du Pont) against the
    ...
    attack.
- **Command roles and ranks.** Frozen commanders: Du Pont and Beauregard (SC004); Gillmore and
  Beauregard (SC005, SC007–SC009, with Gillmore's name misspelled "Qunicy" and "Gilmore" in two
  rows); Terry and Hagood (SC006). The live pages give Beauregard and Gillmore as Brigadier
  Generals; live ranks are not adopted. No listed commander receives automatic sole credit.
- **Tags.** All claims stay `unresolved` or `post_outcome`. The harbor forts, obstructions and
  Wagner predate the actions they defended but are not tagged `inherited`.

The seven null unknowns are the six opening strengths and SC006's logistics. No
