...
The [Peninsula first pass](../docs/research/peninsula-first-pass-v1.md) adds all 16 frozen records: 152 claims, 39 explicit unknowns and one or two source families per record. Casualty differences, opening populations and combined/component overlap remain visible; separate campaign review is pending. Next take Jackson's complete seven-engagement Valley Campaign. Earlier passes and reviews remain in the [current roadmap](../docs/roadmap.md).
