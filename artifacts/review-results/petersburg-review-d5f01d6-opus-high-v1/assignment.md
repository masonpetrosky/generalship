...
Review prepared commit `d5f01d6522e31af05ee06bf708faec77da085e13` against `35cf826`. Sibling inputs.json binds
...
`git show d5f01d6522e31af05ee06bf708faec77da085e13:<path>` first.
...
Write only `artifacts/review-results/petersburg-review-d5f01d6-opus-high-v1/review.md`; do not edit other files, commit or push. State the scope you actually
