...
`/Users/masonpetrosky/Projects/generalship`. Policy commit `29ab815` then changed only
AGENTS.md, README, roadmap and `.claude/agents/`, and removed an undispatched Astra
assignment; no evidence, source or generated artifact changed. Sibling inputs.json
binds 48 paths at the current HEAD.
You are the separate Claude Opus 5.5 `high` reviewer with fresh context. Read AGENTS.md,
...
Write only `artifacts/review-results/heartland-fc79026-opus-high-v1/review.md`.
